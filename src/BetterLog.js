...
var SHEET_LOG_HEADER = 'Message layout: [Date Time]  MillisecondsSinceInvoked  LogLevel  >>  Message. Use Ctrl↓ (or Command↓) to jump to the last row';
//var DATE_TIME_LAYOUT = 'yyyy-MM-dd HH:mm:ss:SSS Z'; //http://docs.oracle.com/javase/6/docs/api/java/text/SimpleDateFormat.html
var DATE_TIME_LAYOUT = 'yyyy-MM-dd HH:mm:ss'; //http://docs.oracle.com/javase/6/docs/api/java/text/SimpleDateFormat.html
...
function convertUsingDefaultPatternLayout_(msg, level) {
  ...
  var message = "[" + dt + "]  (" + Session.getEffectiveUser().getEmail() + ")  >>  " + msg;
  return message;
}
// convert message to text string
